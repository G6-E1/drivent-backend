  ...
  activities.push(
    {
      ...
      startAt: dayjs().month(3).date(3).day(1).hour(9).minute(0).second(0).millisecond(0).toDate(),
      finishAt: dayjs().month(3).date(3).day(1).hour(10).minute(0).second(0).millisecond(0).toDate(),
    },
    {
      name: "Prisma - O ORM do futuro",
      localId: locals[0].id,
      vacancies: locals[0].maxCapacity,
      startAt: dayjs().month(3).date(3).day(1).hour(10).minute(0).second(0).millisecond(0).toDate(),
      finishAt: dayjs().month(3).date(3).day(1).hour(11).minute(0).second(0).millisecond(0).toDate(),
    },
    {
      name: "ChatGPT - A revolução das máquinas começou",
      localId: locals[0].id,
      vacancies: locals[0].maxCapacity,
      startAt: dayjs().month(3).date(3).day(1).hour(11).minute(0).second(0).millisecond(0).toDate(),
      finishAt: dayjs().month(3).date(3).day(1).hour(12).minute(0).second(0).millisecond(0).toDate(),
    },
    {
